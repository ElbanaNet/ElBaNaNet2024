...
(function(n, m, k) {
    var d = {
        widgetTitle: "<h3 class='title dt'>مقالات اخري</h3>",
        widgetStyle: 1,
    ...
    var j = function(a) {
        ...
        e = (typeof labelArray == "object" && labelArray.length > 0) ? "/-/" + encodeURIComponent(l(labelArray)[0]) : "",
        h = function(b) {
        ...
        g = function(z) {
            var s = document.getElementById(d.containerId),
                x = l(z.feed.entry),
                A = d.widgetStyle,
                c = '<div class="rPst">' + d.widgetTitle + '<ul class="s-' + A + ' scrlH">',
